...
<div class="jtc-modal-scrim" :class="supportOpen && 'is-open'" @click="supportOpen = false" x-cloak>
    <div class="jtc-modal jtc-modal--support" @click.stop>
        ...
        <div class="jtc-support__list">
            <a href="tel:+8801329732724" class="jtc-support__item">
                ...
                <span style="flex:1"><span class="jtc-support__title">Call us</span><span class="jtc-support__desc">+880 1329 732 724</span></span>
            ...
            <a href="https://wa.me/8801329732724" target="_blank" rel="noopener" class="jtc-support__item">
            ...
            <a href="https://m.me/juweltradecorporation" target="_blank" rel="noopener" class="jtc-support__item">
        ...
        <div class="jtc-support__social-wrap">
            ...
            <div class="jtc-support__socials">
                <a href="#" class="jtc-support__social jtc-support__social--fb" aria-label="Facebook">
                ...
                <a href="#" class="jtc-support__social jtc-support__social--ig" aria-label="Instagram">
                ...
                <a href="#" class="jtc-support__social jtc-support__social--yt" aria-label="YouTube">
                ...
                <a href="#" class="jtc-support__social jtc-support__social--li" aria-label="LinkedIn">
                    <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20"><path d="M20.45 20.45h-3.56v-5.57c0-1.33-.02-3.04-1.85-3.04-1.85 0-2.14 1.45-2.14 2.94v5.67H9.35V9h3.42v1.56h.05c.48-.9 1.64-1.85 3.37-1.85 3.6 0 4.27 2.37 4.27 5.46v6.28zM5.34 7.43a2.06 2.06 0 1 1 0-4.13 2.06 2.06 0 0 1 0 4.13zM7.12 20.45H3.55V9h3.57v11.45zM22.22 0H1.77C.79 0 0 .77 0 1.72v20.56C0 23.23.79 24 1.77 24h20.45c.98 0 1.78-.77 1.78-1.72V1.72C24 .77 23.2 0 22.22 0z"></path></svg>
                </a>
            </div>
        </div>
    </div>
