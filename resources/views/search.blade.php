    ...
    <section class="sec-style-1 my-3">
        <div class="container">
            ...
            <div class="sec-header">
                <h2 class="sec-title text-primary-color">Search Result: {{ request('search') }}</h2>
        ...
        <div class="container">
            ...
            <ul class="list-inline fs-6 fw-medium">
                <li><i class="fa-solid fa-angles-right text-primary-color"></i> সারা বাংলাদেশে ক্যাশ অন ডেলিভারি
                    এভেইলেবল </li>
                <li><i class="fa-solid fa-angles-right  text-primary-color"></i> আপনি যদি আপনার ক্রয়কৃত ড্রেসটি
